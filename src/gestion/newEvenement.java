 ...
 * @author a-derchain
 */
public class newEvenement extends javax.swing.JFrame {

    /**
     * Creates new form newEvenement
     */
    public newEvenement() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Création d'événement");
        ...
        jLabel6.setText("<html> Nombre de participants <br> maximum :</html>");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
		...
		Transaction transaction = session.beginTransaction();
                Evenement e1 = new Evenement(jLabel1.getText(), jLabel2.getText(), jLabel3.getText(),jLabel4.getText(),jLabel5.getText(),jLabel6.getText(),jLabel7.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(newEvenement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new newEvenement().setVisible(true);
            }
        });
    }
